...
urlpatterns = [
    ...
    # Candidate Skills Management URLs
    ...
    # HR Application Management URLs
    ...
    # Candidate Application Management URLs
    ...
    # Staff Management URLs (Admin/HR)
    ...
    # Admin Skills Database Management URLs
